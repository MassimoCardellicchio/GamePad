...
public static float _movement = 0f;
...
if (_firsttime) { 
 //BA.debugLineNum = 26;BA.debugLine="timer1.Initialize(\"timer1\", 30)";
_timer1.Initialize(processBA,"timer1",(long)(30));
 };
 //BA.debugLineNum = 28;BA.debugLine="gd.Initialize";
mostCurrent._gd._initialize(mostCurrent.activityBA);
 //BA.debugLineNum = 29;BA.debugLine="Dim length, rightPadding, leftPadding, bottomPadding As Int";
_length = 0;
_rightpadding = 0;
_leftpadding = 0;
_bottompadding = 0;
 //BA.debugLineNum = 30;BA.debugLine="length = 200dip 'also the panel's height";
_length = anywheresoftware.b4a.keywords.Common.DipToCurrent((int)(200));
 //BA.debugLineNum = 31;BA.debugLine="rightPadding = 70dip";
_rightpadding = anywheresoftware.b4a.keywords.Common.DipToCurrent((int)(70));
 //BA.debugLineNum = 32;BA.debugLine="leftPadding = 20dip";
_leftpadding = anywheresoftware.b4a.keywords.Common.DipToCurrent((int)(20));
 //BA.debugLineNum = 33;BA.debugLine="bottomPadding = 20dip";
_bottompadding = anywheresoftware.b4a.keywords.Common.DipToCurrent((int)(20));
 //BA.debugLineNum = 34;BA.debugLine="gd.AddToActivity (Activity, leftPadding, 100%y - bottomPadding - length, _ 		100%x - rightPadding - leftPadding, length)";
mostCurrent._gd._addtoactivity(mostCurrent._activity,_leftpadding,(int)(anywheresoftware.b4a.keywords.Common.PerYToCurrent((float)(100),mostCurrent.activityBA)-_bottompadding-_length),(int)(anywheresoftware.b4a.keywords.Common.PerXToCurrent((float)(100),mostCurrent.activityBA)-_rightpadding-_leftpadding),_length);
 //BA.debugLineNum = 36;BA.debugLine="cvs.Initialize(Activity)";
...
mostCurrent._gd = new gamepad();
 //BA.debugLineNum = 18;BA.debugLine="Dim movement As Float";
_movement = 0f;
 //BA.debugLineNum = 19;BA.debugLine="movement = 3dip";
_movement = (float)(anywheresoftware.b4a.keywords.Common.DipToCurrent((int)(3)));
 //BA.debugLineNum = 20;BA.debugLine="Dim cvs As Canvas";
